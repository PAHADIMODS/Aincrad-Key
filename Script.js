(function() {
    ...
    style.innerHTML = `
        ...
        .star-ring { width:220px; height:220px; position:relative; display:flex; align-items:center; justify-content:center; }
        .beat-shape { position:absolute; width:100%; height:100%; border: 4px solid #00f2fe; clip-path: polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%); box-shadow: 0 0 20px #00f2fe; animation: rotate 10s linear infinite; }
        @keyframes rotate { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
        .fetch-txt { color:#00f2fe; margin-top:15px; font-weight:bold; font-size:14px; text-transform:uppercase; }
    `;
    ...
    const render = (sec) => {
        ...
        mko.innerHTML = `
            ...
            <p style="color:#00f2fe; margin-top:20px; font-weight:bold; font-size:18px; letter-spacing:2px;">REDIRECTING...</p>
        `;
        ...
        const i = setInterval(async () => {
            ...
            if (e <= 0) {
                ...
                mko.innerHTML = `
                    <div class="glow-box">
                        <h2 style="color:#00ff00; font-weight:bold; font-size:20px;">AINCARD MODS KEY BYPASS<br>BY PAHADI MODS</h2>
